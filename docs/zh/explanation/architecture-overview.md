...
agent-studio/
├── backend/                          # Java后端服务模块
├── agent-runtime/                    # Python Agent与工作流运行时
├── agent_builder/                    # Python NL2、Prompt与模型调测服务
├── packages/                         # Python共享模型与存储包
├── frontend/                         # Angular前端应用模块
├── docs/                             # 项目文档模块
├── docker/                           # Docker部署配置
├── deploy/                           # 统一部署脚本、Compose与观测配置
...
| 部署服务 | 主要源码 | 职责 |
|----------|----------|------|
| `studio-console` | `frontend/` | Angular 控制台及 API 反向代理 |
| `studio-manager` | `backend/studio-manager*` | Agent、知识库、模型、工具与 MCP 管理 |
...
├── studio-builder/                     # Builder服务Docker配置
...
| **studio-builder/** | Builder服务的Docker配置和启动脚本 |
| **studio-console/** | Console服务的Nginx与镜像构建配置 |
...
| **数据库驱动** | MariaDB JDBC（默认连接MySQL兼容数据库） | 3.5.6 |
| **数据库驱动** | PostgreSQL JDBC | 42.7.11 |
...
│ Agent/知识/工具/MCP/模型管理     │  │ Agent/工作流/LLM/MCP/记忆执行   │
└─────────────────────────────────┘  └─────────────────────────────────┘
                 │ 构建、NL2、Prompt 调用              │
                 ▼                                     │
┌─────────────────────────────────┐                    │
