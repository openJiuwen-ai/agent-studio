...
2. 重新执行依赖同步命令：
   ...
   ```
3. 数据库升级：
   请参考 <a href="https://gitcode.com/openJiuwen/agent-studio/blob/develop/backend/DATABASE_MIGRATION_DEVELOPMENT_GUIDE.md" target="_blank" rel="nofollow noopener noreferrer">DATABASE_MIGRATION_DEVELOPMENT_GUIDE.md</a> 的 <a href="https://gitcode.com/openJiuwen/agent-studio/blob/develop/backend/DATABASE_MIGRATION_DEVELOPMENT_GUIDE.md#2-版本升级说明" target="_blank" rel="nofollow noopener noreferrer">[2. 版本升级说明]</a> 章节进行后端数据库升级。
...
> 关于如何查看本实例的实例ID，请参考[这里](https://gitcode.com/openJiuwen/agent-studio/blob/develop/scripts/README.md#如何查看服务实例的实例id)。
