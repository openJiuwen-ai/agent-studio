...
当前登记 869 个 definition、12 个跨服务 reference。
...
| `1210` | runtime_execution | runtime | frozen | COM-03 激活；Runtime 自有框架错误码 |
| `1310` | builder_execution | builder | frozen | COM-03 新分配；Builder 自有框架错误码 |
...
| `openjiuwen.02001129` | canonical8 | 请求的路由不存在。 | `StudioError.ROUTE_NOT_FOUND` | common | manager | system | 404 | WARN | active | `openjiuwen.02001129` | — | COM-03 framework 404; not a replacement for openjiuwen.02001053 (http_status=500) |
| `openjiuwen.02001130` | canonical8 | 请求的 HTTP 方法不被允许。 | `StudioError.METHOD_NOT_ALLOWED` | common | manager | system | 405 | WARN | active | `openjiuwen.02001130` | — | — |
| `openjiuwen.02001131` | canonical8 | 下游服务依赖调用失败。 | `StudioError.DOWNSTREAM_DEPENDENCY_FAILED` | common | manager | dependency | 502 | ERROR | active | `openjiuwen.02001131` | — | — |
| `openjiuwen.12100001` | canonical8 | 请求参数校验失败。 | `Runtime.REQUEST_VALIDATION_FAILED` | runtime_execution | runtime | system | 400 | WARN | active | `openjiuwen.12100001` | — | — |
| `openjiuwen.12100002` | canonical8 | 请求的路由不存在。 | `Runtime.ROUTE_NOT_FOUND` | runtime_execution | runtime | system | 404 | WARN | active | `openjiuwen.12100002` | — | — |
| `openjiuwen.12100003` | canonical8 | 请求的 HTTP 方法不被允许。 | `Runtime.METHOD_NOT_ALLOWED` | runtime_execution | runtime | system | 405 | WARN | active | `openjiuwen.12100003` | — | — |
| `openjiuwen.12100004` | canonical8 | 服务内部错误。 | `Runtime.INTERNAL_ERROR` | runtime_execution | runtime | system | 500 | ERROR | active | `openjiuwen.12100004` | — | — |
| `openjiuwen.12100005` | canonical8 | 下游 Builder 服务调用失败。 | `Runtime.DOWNSTREAM_BUILDER_FAILED` | runtime_execution | runtime | dependency | 502 | ERROR | active | `openjiuwen.12100005` | — | — |
| `openjiuwen.12100006` | canonical8 | 插件响应格式错误。 | `Runtime.PLUGIN_RESPONSE_FORMAT_FAILED` | runtime_execution | runtime | business | 422 | ERROR | active | `openjiuwen.12100006` | — | SYNC-01 P5-R3 决策 A: canonical for sync_01 legacy integer 105015 (PLUGIN_RESPONSE_FORMAT_ERROR, introduced by 960dbf23, unreleased — not in any tag). 105015 is a Runtime code (vendored jiuwen status_code + restfulapi plugin raise in agent-runtime); mapped to Runtime module 1210 (not Builder 1310 per P0-R.5 record which misattributed to Builder range). 105015 not registered as legacy (unreleased, no consumers) — catch端 maps via is_plugin_response_format_error (direct + __cause__ chain) to this canonical; raise端 keeps 105015 as internal diagnostic StatusCode enum only. |
| `openjiuwen.13100001` | canonical8 | 请求参数校验失败。 | `Builder.REQUEST_VALIDATION_FAILED` | builder_execution | builder | system | 400 | WARN | active | `openjiuwen.13100001` | — | — |
| `openjiuwen.13100002` | canonical8 | 请求的路由不存在。 | `Builder.ROUTE_NOT_FOUND` | builder_execution | builder | system | 404 | WARN | active | `openjiuwen.13100002` | — | — |
| `openjiuwen.13100003` | canonical8 | 请求的 HTTP 方法不被允许。 | `Builder.METHOD_NOT_ALLOWED` | builder_execution | builder | system | 405 | WARN | active | `openjiuwen.13100003` | — | — |
| `openjiuwen.13100004` | canonical8 | 服务内部错误。 | `Builder.INTERNAL_ERROR` | builder_execution | builder | system | 500 | ERROR | active | `openjiuwen.13100004` | — | — |
| `openjiuwen.13100005` | canonical8 | 下游模型服务调用失败。 | `Builder.DOWNSTREAM_MODEL_FAILED` | builder_execution | builder | dependency | 502 | ERROR | active | `openjiuwen.13100005` | — | — |
| `openjiuwen.13100006` | canonical8 | 优化参数非法。 | `Builder.PROMPT_OPTIMIZE_INVALID_PARAMS` | builder_execution | builder | business | 400 | ERROR | active | `openjiuwen.13100006` | manager | DEF-06: Builder-owned canonical code mapped from legacy integer 102154 carried by JiuWenBaseException on Prompt/MMAPO routes; legacy integer not registered to avoid collision with Runtime's independent StatusCode copy. |
| `openjiuwen.13100007` | canonical8 | 优化任务不存在。 | `Builder.PROMPT_OPTIMIZE_JOB_NOT_FOUND` | builder_execution | builder | business | 404 | ERROR | active | `openjiuwen.13100007` | manager | DEF-06: Builder-owned canonical code mapped from legacy integer 102155 carried by JiuWenBaseException on Prompt/MMAPO routes; legacy integer not registered to avoid collision with Runtime's independent StatusCode copy. |
| `openjiuwen.13100008` | canonical8 | 任务状态不允许当前操作。 | `Builder.PROMPT_OPTIMIZE_JOB_STATUS_NOT_EXPECTED` | builder_execution | builder | business | 409 | ERROR | active | `openjiuwen.13100008` | manager | DEF-06: Builder-owned canonical code mapped from legacy integer 102156 carried by JiuWenBaseException on Prompt/MMAPO routes; legacy integer not registered to avoid collision with Runtime's independent StatusCode copy. |
| `openjiuwen.13100009` | canonical8 | 优化任务启动失败。 | `Builder.PROMPT_OPTIMIZE_START_TASK_FAILED` | builder_execution | builder | business | 500 | ERROR | active | `openjiuwen.13100009` | manager | DEF-06: Builder-owned canonical code mapped from legacy integer 102158 carried by JiuWenBaseException on Prompt/MMAPO routes; legacy integer not registered to avoid collision with Runtime's independent StatusCode copy. |
| `openjiuwen.13100010` | canonical8 | 优化任务重启失败。 | `Builder.PROMPT_OPTIMIZE_RESTART_TASK_FAILED` | builder_execution | builder | business | 500 | ERROR | active | `openjiuwen.13100010` | manager | DEF-06: Builder-owned canonical code mapped from legacy integer 102159 carried by JiuWenBaseException on Prompt/MMAPO routes; legacy integer not registered to avoid collision with Runtime's independent StatusCode copy. |
| `openjiuwen.13100011` | canonical8 | 优化任务存储失败。 | `Builder.PROMPT_OPTIMIZE_STORAGE_FAILED` | builder_execution | builder | business | 500 | ERROR | active | `openjiuwen.13100011` | manager | DEF-06: Builder-owned canonical code mapped from legacy integer 102170 carried by JiuWenBaseException on Prompt/MMAPO routes; legacy integer not registered to avoid collision with Runtime's independent StatusCode copy. |
| `openjiuwen.13100012` | canonical8 | 反馈优化失败。 | `Builder.PROMPT_OPTIMIZE_FEEDBACK_FAILED` | builder_execution | builder | business | 500 | ERROR | active | `openjiuwen.13100012` | manager | DEF-06: Builder-owned canonical code mapped from legacy integer 102213 carried by JiuWenBaseException on Prompt/MMAPO routes; legacy integer not registered to avoid collision with Runtime's independent StatusCode copy. |
| `openjiuwen.13100013` | canonical8 | Badcase 优化失败。 | `Builder.PROMPT_OPTIMIZE_BADCASE_FAILED` | builder_execution | builder | business | 500 | ERROR | active | `openjiuwen.13100013` | manager | DEF-06: Builder-owned canonical code mapped from legacy integer 102214 carried by JiuWenBaseException on Prompt/MMAPO routes; legacy integer not registered to avoid collision with Runtime's independent StatusCode copy. |
| `openjiuwen.13100014` | canonical8 | 意图识别失败。 | `Builder.NL2_INTENT_RECOGNITION_FAILED` | builder_execution | builder | business | 500 | ERROR | active | `openjiuwen.13100014` | — | SYNC-01 P5-BLD-01: Builder-owned canonical for sync_01 legacy integer 100029 (NL2 intent recognition / model response error, sync_01 nl2._error_sse_generator). 100029 mapped via _LEGACY_TO_CANONICAL to this canonical; DeepSeek-V3 business suggestion preserved as i18n suggestion field. _error_sse_generator uses COM-03 build_sse_error_event (five-field), no longer raw {code,message} two-field schema. |
