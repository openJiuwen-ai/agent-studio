...
created (e.g. manual stamp, restored DB). This revision re-applies the same
DDL as feat_add_kb_weblink_c7d8e9f0a1b2 in a no-op-safe way.

Revision ID: f504e7d8c9a0
