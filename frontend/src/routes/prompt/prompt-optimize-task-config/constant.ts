    ...
    promptExample: [
      {
        ...
        value:
          ...
          "## 示例 示例1： 用户输入: {'paycardInfo': '默认卡', 'paycardlist': '[卡的下标:0, 卡号:6210000000000000001, 卡描述:借记卡, 别名:储蓄卡, 地区:北京卡的下标:1, 卡号:6210000000000000002, 卡描述:消费卡, 别名:副卡, 地区:广州卡的下标:2, 卡号:6210000000000000003, 卡描述:信用卡, 别名:主卡, 地区:南京]'} 输出: {\"payCard\": [\"0\"]} # 后台查找出的付款卡列表 {{paycardlist}} # 用户提供的付款卡信息 {{paycardInfo}}",
          ...
          [
            {
              ...
              content:
                '[卡的下标:0, 卡号:6210000000000000001, 卡描述:消费卡, 别名:工资卡, 地区:杭州卡的下标:1, 卡号:6210000000000000002, 卡描述:活期账户, 别名:工资卡, 地区:北京]',
            },
            {
              name: 'paycardInfo',
              type: VariableType.TEXT,
          ...
          [
            {
              ...
              type: VariableType.TEXT,
              content:
                '[卡的下标:0, 卡号:6210000000000000003, 卡描述:消费卡, 别名:工资卡, 地区:成都卡的下标:1, 卡号:6210000000000000004, 卡描述:活期账户, 别名:房贷卡, 地区:杭州]',
            },
            {
              name: 'paycardInfo',
              type: VariableType.TEXT,
          ...
          [
            {
              ...
              type: VariableType.TEXT,
              content:
                '[卡的下标:0, 卡号:6210000000000000009, 卡描述:消费卡, 别名:工资卡, 地区:广州卡的下标:1, 卡号:6210000000000000010, 卡描述:活期账户, 别名:房贷卡, 地区:深圳]',
            },
            {
              name: 'paycardInfo',
              type: VariableType.TEXT,
          ...
          [
            {
              ...
              type: VariableType.TEXT,
              content:
                '[卡的下标:0, 卡号:6210000000000000005, 卡描述:消费卡, 别名:工资卡, 地区:广州卡的下标:1, 卡号:6210000000000000006, 卡描述:活期账户, 别名:房贷卡, 地区:深圳]',
            },
            {
              name: 'paycardInfo',
              type: VariableType.TEXT,
          ...
          [
            {
              ...
              type: VariableType.TEXT,
              content:
                '[卡的下标:0, 卡号:6210000000000000007, 卡描述:消费卡, 别名:工资卡, 地区:深圳卡的下标:1, 卡号:6210000000000000008, 卡描述:活期账户, 别名:房贷卡, 地区:南京]',
            },
            {
              name: 'paycardInfo',
              type: VariableType.TEXT,
