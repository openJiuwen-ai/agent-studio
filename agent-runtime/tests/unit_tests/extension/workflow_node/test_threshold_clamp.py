...
class TestSearchKnowledgeRepoThresholdClamp:
    ...
    async def test_threshold_below_min_clamped_and_filters(self, monkeypatch):
    ...
    async def test_threshold_clamped_to_min_still_filters(self, monkeypatch):
    ...
    async def test_no_threshold_no_filtering(self, monkeypatch):
    ...
    async def test_custom_range_no_threshold_negative_score_preserved(self, monkeypatch):
