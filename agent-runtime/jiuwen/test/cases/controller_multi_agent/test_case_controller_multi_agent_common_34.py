...
CASE_ASSET_DIR = CASE_DIR / "test_case_controller_multi_agent_common_34"
AGENT_DIR = CASE_ASSET_DIR / "agent"
SUB_AGENT_DIR = CASE_ASSET_DIR / "sub_agent"
WORKFLOW_DIR = CASE_ASSET_DIR / "workflow"
CASE_FILE = CASE_ASSET_DIR / "test_case_controller_multi_agent_common_34.yaml"
...
def local_ir_path(tmp_path_factory, monkeypatch):
    ...
    tmp_path = tmp_path_factory.mktemp("controller_multi_agent_common34")
