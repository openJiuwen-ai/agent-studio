...
def create_default_workflow(is_streaming: bool = True) -> tuple[Workflow, str]:
    """
    创建理财默认工作流
...
async def test_default_workflow():
    ...
    测试理财默认工作流
    """
    workflow, workflow_id = create_default_workflow(True)  # noqa: redefined-outer-name
