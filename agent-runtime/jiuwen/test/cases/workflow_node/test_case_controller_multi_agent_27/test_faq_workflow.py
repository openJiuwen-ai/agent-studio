...
workflow_id = "aacb7592-31ff-4741-a079-cfc187cabff8"
agent_id = "e21b261d-3792-4942-873b-b3b6fef29537"


def create_faq_workflow(is_streaming: bool = True) -> tuple[Workflow, str]:
    """
    创建利率是多少工作流
    ...
    workflow_card = WorkflowCard(
        id=workflow_id, name="faq_1", version="0.6.0", description="利率是多少"
    )
    ...
    workflow.add_connection("node_start", "node_1747039591166")
    workflow.add_connection("node_1747039591166", "node_end")
...
async def test_faq_workflow():
    ...
    测试利率是多少工作流
    """
    workflow, workflow_id = create_faq_workflow(True)  # noqa: redefined-outer-name
