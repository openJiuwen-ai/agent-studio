...
MINIO_API_PORT="${MINIO_API_PORT:-9000}"; MANAGER_PORT="${MANAGER_PORT:-31111}"; RUNTIME_PORT="${RUNTIME_PORT:-31014}"; BUILDER_PORT="${BUILDER_PORT:-31015}"
...
for s in "mysql:$RUN/mysqld.pid:tcp:$DB_PORT" \
         ...
         "builder:$RUN/builder.pid:http:http://127.0.0.1:$BUILDER_PORT/v1/health" \
